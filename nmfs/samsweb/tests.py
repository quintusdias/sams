...
class SamsTests(TestCase):
    ...
    def generate_elephand_trunk_closed_extended(self):
        ...
        # Shift "Elephant Trunk Closed" values by two years forward.
        # Zero-fill the first two year.

        data['ma_row_0_col_3'] = '0.00'
        data['ma_row_1_col_3'] = '0.00'
        data['ma_row_2_col_3'] = '0.00'
        data['ma_row_3_col_3'] = '0.35'
        data['ma_row_4_col_3'] = '0.45'
        data['ma_row_5_col_3'] = '0.55'
    ...
    def generate_gb6_post_params(self):
        ...
        # Add column 0, 2, 4 to the default scheme
